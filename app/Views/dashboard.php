        ...
        <ul class="flex ltr:ml-auto rtl:mr-auto mt-2">
          ...
          <li x-data="{ open: false }" class="relative">
            <a href="javascript:;" class="px-3 flex text-sm rounded-full focus:outline-none" id="user-menu-button" @click="open = ! open">
              ...
              <span class="hidden md:block ltr:ml-1 rtl:mr-1 self-center"><?= $session->get('username') ?></span>
            </a>
              ...
              <li class="relative">
                <div class="flex flex-wrap flex-row -mx-4 px-3 py-4 items-center">
                  ...
                  <div class="flex-shrink max-w-full px-4 w-2/3 ltr:pl-1 rtl:pr-1">
                    <div class="font-bold"><a href="#" class=" text-gray-800 dark:text-gray-300 hover:text-indigo-500"><?= $session->get('first_name') . " " . $session->get('last_name') ?></a></div>
