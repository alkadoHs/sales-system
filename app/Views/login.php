...
<head>
  ...
  <title>Sales System | Login</title>
  <meta name="description" content="Sales System for managing your business and sales">
  ...
  <header>
    ...
    <nav class="flex flex-row flex-nowrap items-center justify-between mt-0 py-4 px-6 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-800" id="desktop-menu">
      ...
      <ul class="flex ltr:ml-auto rtl:mr-auto mt-2">
        ...
        <li class="relative">
          <a href="/login" class="py-3 px-4 flex hover:text-indigo-500 focus:outline-none">
            <div class="relative inline-block">Login</div>
          </a>
        </li>
        <li class="relative">
          <a href="#" class="py-3 px-4 flex hover:text-indigo-500 focus:outline-none">
            ...
            <div class="relative">
              <div class="p-6 sm:py-8 sm:px-12 rounded-lg bg-white dark:bg-gray-800 shadow-xl">
                <form id="login-form" action="/auth/login" method="post">
                  ...
                  <?php endif ?>
                  <div class="mb-6">
                    <input name="username" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" placeholder="Email address" value="" aria-label="username" type="text" required>
                  </div>
                  <div class="mb-6">
                    <input name="password" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" placeholder="Password" aria-label="password" type="password" required>
                  </div>
                  <div class="grid">
                ...
                <div class="mt-6">
                  <p class="text-center mb-4">Don't have an account? <a class="hover:text-indigo-500" href="register-basic.html">Contact your manajor</a></p>
      ...
      <div class="flex flex-wrap flex-row -mx-4">
        ...
        <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 text-center md:ltr:text-right md:rtl:text-left">
          <p class="mb-0 mt-3 md:mt-0">
            <a href="/index-2.html" class="hover:text-indigo-500">Sales System</a> | All right reserved
          </p>
        </div>
      </div>
    </div>
...
<!-- Mirrored from taildash.tailwinddashboard.com/authentication/login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Sep 2023 08:13:37 GMT -->
</html>