            ...
            <div class="relative">
              <div class="p-6 sm:py-8 sm:px-12 rounded-lg bg-white dark:bg-gray-800 shadow-xl">
                <form id="login-form" action="/auth/login" method="post">
                  ...
                  <?php endif ?>
                  <div class="mb-6">
                    <input name="username" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" placeholder="Username" value="" aria-label="username" type="text" required>
                  </div>
                  <div class="mb-6">
